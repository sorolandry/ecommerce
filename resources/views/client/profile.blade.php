                    ...
                    <form action="" method="post">
                       ...
                       <div class="row">
                          <div class="col-md-6 form-group">
                             ...
                             <input type="text" class="form-control" name="cust_name" value="Héritier N'kele">
                          </div>
                          <div class="col-md-6 form-group">
                          ...
                          <div class="col-md-6 form-group">
                             ...
                             <input type="text" class="form-control" name="" value="heir@gmail.com" disabled>
                          </div>
                          <div class="col-md-6 form-group">
                             <label for="">Phone Number *</label>
                             <input type="text" class="form-control" name="cust_phone" value="0824754958">
                          </div>
                          <div class="col-md-12 form-group">
                             <label for="">Address *</label>
                             <textarea name="cust_address" class="form-control" cols="30" rows="10" style="height:70px;">Av. Malula num 12 Lemba/Righini</textarea>
                          </div>
                          <div class="col-md-6 form-group">
                             ...
                             <select name="cust_country" class="form-control">
                                ...
                                <option value="243" selected>Zaire</option>
                          ...
                          <div class="col-md-6 form-group">
                             ...
                             <input type="text" class="form-control" name="cust_city" value="Kinshasa">
                          </div>
                          <div class="col-md-6 form-group">
                             <label for="">State *</label>
                             <input type="text" class="form-control" name="cust_state" value="Kinshasa">
                          </div>
                          <div class="col-md-6 form-group">
                             <label for="">Zip Code *</label>
                             <input type="text" class="form-control" name="cust_zip" value="3287">
                          </div>
                       </div>
